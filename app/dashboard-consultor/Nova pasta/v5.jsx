...
function Card({ children, style }) {
  return <div style={{ background: COLORS.panel, border: `1px solid ${COLORS.border}`, borderRadius: 14, boxShadow: "0 6px 20px rgba(0,0,0,0.22)", ...style }}>{children}</div>;
}
  ...
  return (
    <Card style={{ padding: 9 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5, gap: 6 }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: COLORS.text, lineHeight: 1.1 }}>{title}</div>
        {Icon ? <Icon size={14} color={COLORS.subtext} /> : null}
      </div>
      <div style={{ fontSize: 13, color: COLORS.subtext, marginBottom: 5, fontWeight: 700 }}>{value}</div>
      ...
      <div style={{ marginTop: 5, fontSize: 10, color: COLORS.subtext, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{subtitle}</div>
    </Card>
  );
}
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.bg, color: COLORS.text }}>
      <div style={{ background: COLORS.navy, borderBottom: `1px solid ${COLORS.border}` }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: "8px 16px", display: "flex", alignItems: "center", gap: 12 }}>
          <img
            src="/logo/logo.png"
            alt="Logo"
            style={{ width: 58, height: 58, objectFit: "contain", borderRadius: 10 }}
          />
          <div>
            <div style={{ fontSize: 12, fontWeight: 700, color: COLORS.subtext }}>BI Service Beta</div>
            <div style={{ fontSize: 22, fontWeight: 900, color: "#fff", lineHeight: 1.05 }}>Dashboard Consultor</div>
            <div style={{ fontSize: 12, color: COLORS.subtext, marginTop: 3 }}>Upload inteligente • metas • ranking • relatório</div>
          </div>
        </div>
      </div>

      <div style={{ maxWidth: 1440, margin: "0 auto", padding: 10 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 8, marginBottom: 8, alignItems: "stretch" }}>
          <Card style={{ padding: 8, minHeight: 62, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            >
              <Upload size={15} color={isDragging ? COLORS.blue : COLORS.orange} />
              <div style={{ fontSize: 12, fontWeight: 800, color: COLORS.text, marginTop: 2, pointerEvents: "none" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 220px", gap: 8, marginBottom: 8 }}>
          ...
          <Card style={{ padding: 10 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: COLORS.subtext }}>Consultores</div>
            <div style={{ fontSize: 24, fontWeight: 900, color: COLORS.text, marginTop: 4 }}>{filtered.length}</div>
          </Card>
        </div>
