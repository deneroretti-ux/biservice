  ...
  return (
    <Card style={{ padding: 6 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8, gap: 8 }}>
        <div style={{ fontSize: 9, fontWeight: 800, color: COLORS.text, lineHeight: 1.05 }}>{title}</div>
        {Icon ? <Icon size={13} color={COLORS.subtext} /> : null}
      </div>
      <div style={{ fontSize: 9, color: COLORS.subtext, marginBottom: 3, fontWeight: 700 }}>{value}</div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.bg, color: COLORS.text }}>
      <div style={{ background: COLORS.navy, borderBottom: `1px solid ${COLORS.border}` }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: "6px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 9, fontWeight: 700, color: COLORS.subtext }}>BI Service Beta</div>
              <div style={{ fontSize: 18, fontWeight: 900, color: "#fff", lineHeight: 1.05 }}>Dashboard Consultor</div>
              <div style={{ fontSize: 9, color: COLORS.subtext, marginTop: 2 }}>Upload inteligente • metas • ranking • relatório</div>
            </div>
          </div>

          <Card style={{ padding: 6, width: 470, minHeight: 48, flexShrink: 0 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, marginBottom: 4 }}>
              <div style={{ fontSize: 9, fontWeight: 700, color: COLORS.subtext }}>Importar planilhas/pasta</div>
            ...
            >
              ...
              <div style={{ fontSize: 9, fontWeight: 800, color: COLORS.text, pointerEvents: "none" }}>
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", padding: 6 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 140px", gap: 6, marginBottom: 6 }}>
          <Card style={{ padding: 6 }}>
          ...
          <Card style={{ padding: 6 }}>
            <div style={{ fontSize: 9, fontWeight: 700, color: COLORS.subtext }}>Consultores</div>
        ...
        {!noData && current ? (
          <>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))", gap: 5, marginBottom: 5 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.32fr 0.68fr", gap: 6, marginBottom: 6 }}>
              <Card style={{ padding: 4 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6, gap: 10, flexWrap: "wrap" }}>
                  <div>
                    <div style={{ fontSize: 12, fontWeight: 900 }}>Ranking de consultores</div>
                    <div style={{ fontSize: 9, color: COLORS.subtext }}>Top 10 • linha tracejada = meta</div>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "nowrap", width: "100%" }}>
                    ...
                    <div style={{ display: "flex", gap: 5, justifyContent: "flex-end", flexWrap: "wrap", flexShrink: 0 }}>
                    {[
                      ["score", "Score"],
                      ["receita", "Receita"],
                      ["conversao", "Conversão"],
                ...
                <div style={{ height: rankingChartHeight, overflowY: rankingChartHeight > 360 ? "auto" : "visible" }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={rankingSelectedData} layout="vertical" margin={{ left: 30, right: 10, top: 8, bottom: 8 }} onClick={(state) => {
                      ...
                      <YAxis dataKey="nome" type="category" width={78} tick={{ fontSize: 8 }} />
              ...
              <Card style={{ padding: 16 }}>
                <div style={{ fontSize: 12, fontWeight: 900, marginBottom: 3 }}>Comparativo com a média</div>
                {average ? (
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}>
                    {[
                      ...
                      <div key={label} style={{ background: COLORS.panelAlt, border: `1px solid ${COLORS.border}`, borderRadius: 12, padding: 10, minHeight: 72 }}>
                        <div style={{ fontSize: 9, color: COLORS.subtext, fontWeight: 700, lineHeight: 1.05 }}>{label}</div>
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 1, marginTop: 1 }}>
                          <div style={{ fontWeight: 900, fontSize: 10, color: mineColor, lineHeight: 1 }}>{mine}</div>
                          <div style={{ fontSize: 8, fontWeight: 800, color: avgColor, lineHeight: 1 }}>Média {avg}</div>
                        </div>
                      </div>
                    ))}
                  </div>
