      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", padding: 6 }}>
        ...
        {!noData && current ? (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "0.95fr 1.05fr", gap: 6, marginBottom: 6 }}>
              <Card style={{ padding: 4 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6, gap: 10, flexWrap: "wrap" }}>
                  <div>
                    <div style={{ fontSize: 16, fontWeight: 900 }}>Ranking de consultores</div>
                ...
                <div style={{ height: rankingChartHeight, overflowY: rankingChartHeight > 360 ? "auto" : "visible" }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={rankingSelectedData} layout="vertical" margin={{ left: 30, right: 10, top: 8, bottom: 8 }} onClick={(state) => {
                      ...
                      <Bar dataKey="valor" barSize={9} radius={[0, 8, 8, 0]}>
              ...
              <Card style={{ padding: 16 }}>
                <div style={{ fontSize: 16, fontWeight: 900, marginBottom: 10 }}>Comparativo com a média</div>
                {average ? (
                    ...
                    {[
                      ...
                      <div key={label} style={{ background: COLORS.panelAlt, border: `1px solid ${COLORS.border}`, borderRadius: 12, padding: 10, minHeight: 72 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 2, marginTop: 4 }}>
                          <div style={{ fontWeight: 900, fontSize: 13, color: mineColor, lineHeight: 1.05 }}>{mine}</div>
                          <div style={{ fontSize: 10, fontWeight: 800, color: avgColor, lineHeight: 1.05 }}>Média {avg}</div>
                        </div>
                      </div>
                    ))}
                  </div>
