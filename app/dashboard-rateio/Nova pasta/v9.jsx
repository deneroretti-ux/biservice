...
export default function DashboardRateioUploadInteligentePage() {
  ...
  const generatedBudgetMetaForPlano = (plano, empresaFiltro = "Todas", monthKeySet = null) => {
    ...
    for (const item of items) {
      ...
      const manualTotal = getManualBudgetCellValueAny(budgetManualCells, item?.empresa, manualKeys, "Todos");
      if (manualTotal != null) {
      ...
      for (const [mes, mm] of filteredMonths) {
        const manualMes = getManualBudgetCellValueAny(budgetManualCells, item?.empresa, manualKeys, mes);
